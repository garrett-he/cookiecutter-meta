...
def test_bake_pyproject_toml(cookies: Cookies):
    context = generate_context()
    result = cookies.bake(extra_context=context)
    assert not result.exception
    ...
    assert pyproject['tool']['poetry']['name'] == context['template_name']
    assert pyproject['tool']['poetry']['description'] == context['template_description']
